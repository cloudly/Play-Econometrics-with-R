...
```r
HPrice <- read.dta("data/hprice1.dta", convert.dates = TRUE, convert.factors = TRUE, 
    missing.type = FALSE, convert.underscore = TRUE, warn.missing.labels = TRUE)
...
```
## Warning message: 'ncv.test' is deprecated.
## Use 'ncvTest' instead.
## See help("Deprecated") and help("car-deprecated").
```
...
```
## Error: could not find function "vcovHC"
```
...
```
## Error: could not find function "tobit"
```
...
```
## Error: object 'MROZ_Tobit' not found
```
...
```
## Warning message: data set 'BankWages' not found
```
...
```
## Error: object 'BankWages' not found
```
...
```
## Warning message: data set 'RecreationDemand' not found
```
...
```
## Error: object 'RecreationDemand' not found
```
...
```
## Error: could not find function "dispersiontest"
```
...
```
## Error: there is no package called 'pscl'
```
...
```
## Error: object 'CRIME1_zip' not found
```
...
```
## Error: there is no package called 'sampleSelection'
```
...
```
## Error: object 'MROZ_Heckit' not found
```
...
```
## Error: could not find function "tsls"
```
...
```
## Error: object 'MROZ_2SLS' not found
```
...
```
## Error: there is no package called 'systemfit'
```
...
```
## Error: could not find function "plm.data"
```
...
```
## Error: could not find function "systemfit"
```
...
```
## Warning message: cannot open compressed file 'data/CRIME2.rda', probable reason 'No such file or directory'
```
